...
# Define Constants 
ball_radius = 0.0762
ball_csarea = np.pi * (ball_radius**2)
...
def solve(vx0, vy0, vz0, omega0_param, t0=0, dt=0.01, sim_end_time=10, sx0=0, sy0=0, sz0=0):
    global omega0
    omega0 = omega0_param
...
vel_approx_tlist, vx_list, vy_list, vz_list, pos_approx_tlist, sx_list, sy_list, sz_list = solve(8, 12, 3, 500)
