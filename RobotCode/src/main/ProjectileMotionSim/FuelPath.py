...
fuel_solver = pp.ProjectileSolver(fuel, xt, yt, zt, vxi0, vyi0, vzi0, omegai0, vx_frame=vx_robot, vy_frame=vy_robot, vz_frame=vz_robot, omega_frame=omega_robot, fix_speed=False, fix_omega=False, lm_iters=3, sim_end_time=5, dt=0.01, clearance_func=fc.hub_clearance)
...
# display results 
vel_approx_tlist, vx_list, vy_list, vz_list, speedf, pos_approx_tlist, sx_list, sy_list, sz_list, omegaf = fuel.trajectory(fuel_solver.vx+vx_robot, fuel_solver.vy+vy_robot, fuel_solver.vz+vz_robot, fuel_solver.omega+omega_robot, dt=0.001, stop_on_y=yt) # smaller dt=more refined approximation
...
table = [
    ...
    ["Total Spin (rad/s)", fuel_solver.omega + omega_robot],
