...
surf1 = ax1.plot_surface(R, VF, theta_slice, cmap='viridis', edgecolor='k')
ax1.set_xlabel('Distance to Hub r (m)')
ax1.set_ylabel('Forward Robot Velocity vf (m/s)')
...
surf2 = ax2.plot_surface(R, VL, phi_slice, cmap='plasma', edgecolor='k')
ax2.set_xlabel('Distance to Hub r (m)')
ax2.set_ylabel('Lateral Robot Velocity vl (m/s)')
