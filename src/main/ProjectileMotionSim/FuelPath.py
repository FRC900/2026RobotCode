...
fuel_solver = pp.ProjectileSolver(fuel, xt, yt, zt, vxi0, vyi0, vzi0, omegai0, lm_iters=3, sim_end_time=5, dt=0.01, v_bounds=(10, 10), omega_bounds=(10, 10), sy0=0.3, clearance_func=pp.hub_clearance)
