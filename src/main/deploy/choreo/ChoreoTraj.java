...
public record ChoreoTraj(
    ...
    public static final ChoreoTraj FourPointZeroFiveMetersFromEdgeToOutpostThenCenter = new ChoreoTraj(
    ...
    public static final Map<String, ChoreoTraj> ALL_TRAJECTORIES = Map.ofEntries(
        Map.entry("FourPointZeroFiveMetersFromEdgeToOutpostThenCenter", FourPointZeroFiveMetersFromEdgeToOutpostThenCenter)
    );
