...
public class RobotViz {
    ...
    private static final Translation3d HOOD_PIVOT_OFFSET = new Translation3d(0.223907,0,0).minus(new Translation3d(0.148908,0,0));
    ...
    public void updateViz() {
        if (state.getLatestRobotToTurret().getValue() != null) {
            ...
            shooterPose3d = new Pose3d(new Translation3d(   -0.148908,-0.152400,0.260636 + 0.09525), new Rotation3d(0, 0, turretRotation));
            ...
            hoodPose3d =
                    new Pose3d(
                            new Translation3d(-0.148908,-0.152400,0.342476 + 0.09525).minus(rotatedHoodPivot),
                            new Rotation3d(
                                    0,
