...
public class TurretFactory {
    ...
    public static Command aimTurretToPose(RobotContainer container, Supplier<ShooterSetpoint> setpointSupplier) {
        ...
        return container.getTurretSubsystem().positionSetpointCommand(
    ...
    public static Command holdPositionRadians(RobotContainer container, double radians) {
        return Commands.run(() -> container.getTurretSubsystem().positionSetpointCommand(() -> radians, () -> 0.0), container.getTurretSubsystem())
