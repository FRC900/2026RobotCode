  ...
  public void periodic() {
    ...
    for (int cameraIndex = 0; cameraIndex < io.length; cameraIndex++) {
      ...
      for (int tagId : inputs[cameraIndex].tagIds) {
        var tagPose = AprilTagFieldLayout.loadField(AprilTagFields.k2026RebuiltAndymark).getTagPose(tagId);
      ...
      for (var observation : inputs[cameraIndex].poseObservations) {
        ...
        boolean rejectPose =
            observation.tagCount() == 0 // Must have at least one tag
                ...
                || observation.pose().getX() > AprilTagFieldLayout.loadField(AprilTagFields.k2026RebuiltAndymark).getFieldLength()
                || observation.pose().getY() < 0.0
                || observation.pose().getY() > AprilTagFieldLayout.loadField(AprilTagFields.k2026RebuiltAndymark).getFieldWidth();
