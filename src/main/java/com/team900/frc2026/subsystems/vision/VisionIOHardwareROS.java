...
//     public VisionIOHardwareROS(RobotState robotState) {
...
//         double[] cameraTPose = {
//             VisionConstants.kRobotToCameraTForward,
//             VisionConstants.kRobotToCameraTSide,
//             VisionConstants.kCameraTHeightOffGroundMeters,
//             0.0,
//             VisionConstants.kCameraTPitchDegrees,
//             VisionConstants.kCameraTYawOffset.getDegrees()
//         };

//         tableT.getEntry("camerapose_robotspace_set").setDoubleArray(cameraTPose);
//     }

//     @Override
//     public void readInputs(VisionIOInputs inputs) {
//         readCameraData(tableA, inputs.cameraA, VisionConstants.kROSATableName);
//         readCameraData(tableB, inputs.cameraB, VisionConstants.kROSBTableName);
//         readCameraData(tableT, inputs.cameraT, VisionConstants.kROSTTableName);
...
//                 if (megatag != null) {
//                     camera.megatagPoseEstimate = TagPoseEstimate.fromLimelight(megatag);
