    ...
    protected ModuleIOTalonFX(
        ...
        if (Constants.currentMode == Mode.SIM){
            turnConfig.Slot0 =
                    SimTunerConstants.FrontLeft
                            .SteerMotorGains; // during simulation, gains are slightly different
        }
        ...
        turnConfig.MotorOutput.Inverted =
                constants.SteerMotorInverted
                        ...
                        : InvertedValue.CounterClockwise_Positive;
        tryUntilOK(
                () -> turnTalon.getConfigurator().apply(turnConfig, 0.25), turnTalon.getDeviceID());
    ...
    public void setDriveVelocity(double wheelVelocityRadPerSec) {
        ...
        driveTalon.setControl(
                switch (constants.DriveMotorClosedLoopOutput) {
                    ...
                    case TorqueCurrentFOC -> velocityVoltageRequest
                            .withEnableFOC(true)
    ...
    public void setTurnPosition(Rotation2d rotation) {
        turnTalon.setControl(
                switch (constants.SteerMotorClosedLoopOutput) {
                    ...
                    case TorqueCurrentFOC -> positionVoltageRequest
                            .withEnableFOC(true)
