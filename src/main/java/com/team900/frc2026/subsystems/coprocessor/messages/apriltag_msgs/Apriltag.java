...
public class Apriltag extends frc.team88.ros.messages.RosMessage {
    ...
    private int bits = 0;
    private frc.team88.ros.messages.geometry_msgs.Point center = new frc.team88.ros.messages.geometry_msgs.Point();
    private frc.team88.ros.messages.geometry_msgs.Point[] corners = new frc.team88.ros.messages.geometry_msgs.Point[] {
    ...
    public Apriltag(int id, java.lang.String family, int hamming, int border, int bits, frc.team88.ros.messages.geometry_msgs.Point center, frc.team88.ros.messages.geometry_msgs.Point[] corners) {
        this.id = id;
        this.family = family;
    ...
    public Apriltag(JsonObject jsonObj) {
        ...
        this.center = new frc.team88.ros.messages.geometry_msgs.Point(jsonObj.get("center").getAsJsonObject());
        int corners_element_index = 0;
        for (JsonElement corners_element : jsonObj.getAsJsonArray("corners")) {
            this.corners[corners_element_index++] = new frc.team88.ros.messages.geometry_msgs.Point(corners_element.getAsJsonObject());
        }
    }
