...
public class TurretConstants {
    ...
    public static final double turretOffSetFromCenterX = 0.5; // parallel to the front bumpers, need to tune this
    public static final double turretOffSetFromCenterY = 0.3; // parallel to the side bumpers, need to tune this
