...
/**
 * The BridgePublisher class is responsible for subscibing to data from the ROS host using
...
public class BridgeSubscriber<T extends RosMessage> {
    ...
    /**
     * Constructor that initializes the BridgeSubscriber with a ROSNetworkTablesBridge instance,
     * topic name, and Class type.
     *
    ...
    /**
     * Receives the latest data from the ROS topic and converts it to an instance of the specified
     * class.
     *
     * @return An instance of the specified class containing the received data, or null if no new
     *     data is available.
     */
