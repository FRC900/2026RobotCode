...
public class MagneticField extends com.team900.lib.rosNetworkTablesBridge.messages.RosMessage {
    ...
    private com.team900.lib.rosNetworkTablesBridge.messages.geometry_msgs.Vector3 magnetic_field =
            new com.team900.lib.rosNetworkTablesBridge.messages.geometry_msgs.Vector3();
    private java.lang.Double[] magnetic_field_covariance =
    ...
    public MagneticField(
            ...
            com.team900.lib.rosNetworkTablesBridge.messages.geometry_msgs.Vector3 magnetic_field,
            java.lang.Double[] magnetic_field_covariance) {
        this.header = header;
    ...
    public MagneticField(JsonObject jsonObj) {
        ...
        this.magnetic_field =
                new com.team900.lib.rosNetworkTablesBridge.messages.geometry_msgs.Vector3(
                        jsonObj.get("magnetic_field").getAsJsonObject());
        int magnetic_field_covariance_element_index = 0;
        for (JsonElement magnetic_field_covariance_element :
                jsonObj.getAsJsonArray("magnetic_field_covariance")) {
            this.magnetic_field_covariance[magnetic_field_covariance_element_index++] =
                    magnetic_field_covariance_element.getAsDouble();
        }
    }
