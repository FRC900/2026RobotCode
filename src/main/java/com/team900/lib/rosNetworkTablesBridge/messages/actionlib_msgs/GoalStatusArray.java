...
public class GoalStatusArray extends com.team900.lib.rosNetworkTablesBridge.messages.RosMessage {
    ...
    private ArrayList<com.team900.lib.rosNetworkTablesBridge.messages.actionlib_msgs.GoalStatus> status_list = new ArrayList<>();
    ...
    public GoalStatusArray(com.team900.lib.rosNetworkTablesBridge.messages.std_msgs.RosHeader header, com.team900.lib.rosNetworkTablesBridge.messages.actionlib_msgs.GoalStatus[] status_list) {
        this.header = header;
    ...
    public GoalStatusArray(JsonObject jsonObj) {
        ...
        for (JsonElement status_list_element : jsonObj.getAsJsonArray("status_list")) {
            this.status_list.add(new com.team900.lib.rosNetworkTablesBridge.messages.actionlib_msgs.GoalStatus(status_list_element.getAsJsonObject()));
        }
    }
    ...
    public ArrayList<com.team900.lib.rosNetworkTablesBridge.messages.actionlib_msgs.GoalStatus> getStatusList() {
    ...
    public void setStatusList(ArrayList<com.team900.lib.rosNetworkTablesBridge.messages.actionlib_msgs.GoalStatus> status_list) {
