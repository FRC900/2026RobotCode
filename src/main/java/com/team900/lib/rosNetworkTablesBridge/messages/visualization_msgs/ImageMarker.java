...
public class ImageMarker extends com.team900.lib.rosNetworkTablesBridge.messages.RosMessage {
    ...
    private com.team900.lib.rosNetworkTablesBridge.messages.std_msgs.RosColorRGBA outline_color = new com.team900.lib.rosNetworkTablesBridge.messages.std_msgs.RosColorRGBA();
    private byte filled = 0;
    private com.team900.lib.rosNetworkTablesBridge.messages.std_msgs.RosColorRGBA fill_color = new com.team900.lib.rosNetworkTablesBridge.messages.std_msgs.RosColorRGBA();
    ...
    private ArrayList<com.team900.lib.rosNetworkTablesBridge.messages.std_msgs.RosColorRGBA> outline_colors = new ArrayList<>();
    ...
    public ImageMarker(com.team900.lib.rosNetworkTablesBridge.messages.std_msgs.RosHeader header, java.lang.String ns, int id, int type, int action, com.team900.lib.rosNetworkTablesBridge.messages.geometry_msgs.Point position, float scale, com.team900.lib.rosNetworkTablesBridge.messages.std_msgs.RosColorRGBA outline_color, byte filled, com.team900.lib.rosNetworkTablesBridge.messages.std_msgs.RosColorRGBA fill_color, com.team900.lib.rosNetworkTablesBridge.messages.DurationPrimitive lifetime, com.team900.lib.rosNetworkTablesBridge.messages.geometry_msgs.Point[] points, com.team900.lib.rosNetworkTablesBridge.messages.std_msgs.RosColorRGBA[] outline_colors) {
        this.header = header;
        this.ns = ns;
        this.id = id;
        this.type = type;
    ...
    public ImageMarker(JsonObject jsonObj) {
        ...
        this.outline_color = new com.team900.lib.rosNetworkTablesBridge.messages.std_msgs.RosColorRGBA(jsonObj.get("outline_color").getAsJsonObject());
        this.filled = jsonObj.get("filled").getAsByte();
        this.fill_color = new com.team900.lib.rosNetworkTablesBridge.messages.std_msgs.RosColorRGBA(jsonObj.get("fill_color").getAsJsonObject());
        ...
        for (JsonElement outline_colors_element : jsonObj.getAsJsonArray("outline_colors")) {
            this.outline_colors.add(new com.team900.lib.rosNetworkTablesBridge.messages.std_msgs.RosColorRGBA(outline_colors_element.getAsJsonObject()));
        }
    }
    ...
    public ArrayList<com.team900.lib.rosNetworkTablesBridge.messages.std_msgs.RosColorRGBA> getOutlineColors() {
    ...
    public void setOutlineColor(com.team900.lib.rosNetworkTablesBridge.messages.std_msgs.RosColorRGBA outline_color) {
        this.outline_color = outline_color;
    }
    public void setFilled(byte filled) {
        this.filled = filled;
    }
    public void setFillColor(com.team900.lib.rosNetworkTablesBridge.messages.std_msgs.RosColorRGBA fill_color) {
        this.fill_color = fill_color;
    }
    ...
    public void setOutlineColors(ArrayList<com.team900.lib.rosNetworkTablesBridge.messages.std_msgs.RosColorRGBA> outline_colors) {
