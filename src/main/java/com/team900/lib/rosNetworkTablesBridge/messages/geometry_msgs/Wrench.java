...
public class Wrench extends com.team900.lib.rosNetworkTablesBridge.messages.RosMessage {
    ...
    private com.team900.lib.rosNetworkTablesBridge.messages.geometry_msgs.Vector3 force =
            new com.team900.lib.rosNetworkTablesBridge.messages.geometry_msgs.Vector3();
    private com.team900.lib.rosNetworkTablesBridge.messages.geometry_msgs.Vector3 torque =
            new com.team900.lib.rosNetworkTablesBridge.messages.geometry_msgs.Vector3();
    ...
    public Wrench(
            com.team900.lib.rosNetworkTablesBridge.messages.geometry_msgs.Vector3 force,
            com.team900.lib.rosNetworkTablesBridge.messages.geometry_msgs.Vector3 torque) {
        this.force = force;
        this.torque = torque;
    }
    ...
    public Wrench(JsonObject jsonObj) {
        this.force =
                new com.team900.lib.rosNetworkTablesBridge.messages.geometry_msgs.Vector3(
                        jsonObj.get("force").getAsJsonObject());
        this.torque =
                new com.team900.lib.rosNetworkTablesBridge.messages.geometry_msgs.Vector3(
                        jsonObj.get("torque").getAsJsonObject());
    }
