...
public class InteractiveMarker extends com.team900.lib.rosNetworkTablesBridge.messages.RosMessage {
    ...
    private ArrayList<com.team900.lib.rosNetworkTablesBridge.messages.visualization_msgs.MenuEntry>
            menu_entries = new ArrayList<>();
    private ArrayList<
                    com.team900
                            .lib
    ...
    public InteractiveMarker(
            ...
            float scale,
            com.team900.lib.rosNetworkTablesBridge.messages.visualization_msgs.MenuEntry[]
                    menu_entries,
            com.team900
                            .lib
                            .rosNetworkTablesBridge
    ...
    public InteractiveMarker(JsonObject jsonObj) {
        ...
        for (JsonElement menu_entries_element : jsonObj.getAsJsonArray("menu_entries")) {
            this.menu_entries.add(
                    new com.team900
                            .lib
                            .rosNetworkTablesBridge
                            .messages
                            .visualization_msgs
                            .MenuEntry(menu_entries_element.getAsJsonObject()));
        }
        for (JsonElement controls_element : jsonObj.getAsJsonArray("controls")) {
            this.controls.add(
                    new com.team900
                            ...
                            .messages
                            .visualization_msgs
                            .InteractiveMarkerControl(controls_element.getAsJsonObject()));
        }
    }
    ...
    public ArrayList<com.team900.lib.rosNetworkTablesBridge.messages.visualization_msgs.MenuEntry>
            getMenuEntries() {
    ...
    public void setMenuEntries(
            ArrayList<com.team900.lib.rosNetworkTablesBridge.messages.visualization_msgs.MenuEntry>
                    menu_entries) {
