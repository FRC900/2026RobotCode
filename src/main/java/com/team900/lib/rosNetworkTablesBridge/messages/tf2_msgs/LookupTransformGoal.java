...
public class LookupTransformGoal
    ...
    private com.team900.lib.rosNetworkTablesBridge.messages.TimePrimitive source_time =
            new com.team900.lib.rosNetworkTablesBridge.messages.TimePrimitive();
    private com.team900.lib.rosNetworkTablesBridge.messages.DurationPrimitive timeout =
            new com.team900.lib.rosNetworkTablesBridge.messages.DurationPrimitive();
    private com.team900.lib.rosNetworkTablesBridge.messages.TimePrimitive target_time =
            new com.team900.lib.rosNetworkTablesBridge.messages.TimePrimitive();
    ...
    public LookupTransformGoal(
            java.lang.String target_frame,
            java.lang.String source_frame,
            com.team900.lib.rosNetworkTablesBridge.messages.TimePrimitive source_time,
            com.team900.lib.rosNetworkTablesBridge.messages.DurationPrimitive timeout,
            com.team900.lib.rosNetworkTablesBridge.messages.TimePrimitive target_time,
            java.lang.String fixed_frame,
            boolean advanced) {
    ...
    public LookupTransformGoal(JsonObject jsonObj) {
        ...
        this.source_time =
                new com.team900.lib.rosNetworkTablesBridge.messages.TimePrimitive(
                        jsonObj.get("source_time").getAsJsonObject());
        this.timeout =
                new com.team900.lib.rosNetworkTablesBridge.messages.DurationPrimitive(
                        jsonObj.get("timeout").getAsJsonObject());
        this.target_time =
                new com.team900.lib.rosNetworkTablesBridge.messages.TimePrimitive(
                        jsonObj.get("target_time").getAsJsonObject());
