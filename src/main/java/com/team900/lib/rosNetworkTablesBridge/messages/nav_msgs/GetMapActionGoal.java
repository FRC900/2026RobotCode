...
public class GetMapActionGoal extends com.team900.lib.rosNetworkTablesBridge.messages.RosMessage {
    ...
    private com.team900.lib.rosNetworkTablesBridge.messages.nav_msgs.GetMapGoal goal = new com.team900.lib.rosNetworkTablesBridge.messages.nav_msgs.GetMapGoal();
    ...
    public GetMapActionGoal(com.team900.lib.rosNetworkTablesBridge.messages.std_msgs.RosHeader header, com.team900.lib.rosNetworkTablesBridge.messages.actionlib_msgs.GoalID goal_id, com.team900.lib.rosNetworkTablesBridge.messages.nav_msgs.GetMapGoal goal) {
        this.header = header;
    ...
    public GetMapActionGoal(JsonObject jsonObj) {
        ...
        this.goal = new com.team900.lib.rosNetworkTablesBridge.messages.nav_msgs.GetMapGoal(jsonObj.get("goal").getAsJsonObject());
    }
