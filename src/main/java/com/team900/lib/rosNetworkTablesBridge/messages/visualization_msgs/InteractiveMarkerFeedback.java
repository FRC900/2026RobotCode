...
public class InteractiveMarkerFeedback
    ...
    private com.team900.lib.rosNetworkTablesBridge.messages.geometry_msgs.Point mouse_point =
    ...
    public InteractiveMarkerFeedback(
            ...
            java.lang.String marker_name,
            java.lang.String control_name,
            byte event_type,
            com.team900.lib.rosNetworkTablesBridge.messages.geometry_msgs.Pose pose,
            int menu_entry_id,
            com.team900.lib.rosNetworkTablesBridge.messages.geometry_msgs.Point mouse_point,
    ...
    public InteractiveMarkerFeedback(JsonObject jsonObj) {
        ...
        this.mouse_point =
                new com.team900.lib.rosNetworkTablesBridge.messages.geometry_msgs.Point(
                        jsonObj.get("mouse_point").getAsJsonObject());
