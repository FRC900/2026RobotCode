...
public class InteractiveMarkerFeedback extends com.team900.lib.rosNetworkTablesBridge.messages.RosMessage {
    ...
    private com.team900.lib.rosNetworkTablesBridge.messages.geometry_msgs.Point mouse_point = new com.team900.lib.rosNetworkTablesBridge.messages.geometry_msgs.Point();
    ...
    public InteractiveMarkerFeedback(com.team900.lib.rosNetworkTablesBridge.messages.std_msgs.RosHeader header, java.lang.String client_id, java.lang.String marker_name, java.lang.String control_name, byte event_type, com.team900.lib.rosNetworkTablesBridge.messages.geometry_msgs.Pose pose, int menu_entry_id, com.team900.lib.rosNetworkTablesBridge.messages.geometry_msgs.Point mouse_point, boolean mouse_point_valid) {
        this.header = header;
    ...
    public InteractiveMarkerFeedback(JsonObject jsonObj) {
        ...
        this.mouse_point = new com.team900.lib.rosNetworkTablesBridge.messages.geometry_msgs.Point(jsonObj.get("mouse_point").getAsJsonObject());
    ...
    public com.team900.lib.rosNetworkTablesBridge.messages.geometry_msgs.Point getMousePoint() {
    ...
    public void setMousePoint(com.team900.lib.rosNetworkTablesBridge.messages.geometry_msgs.Point mouse_point) {
        this.mouse_point = mouse_point;
    }
