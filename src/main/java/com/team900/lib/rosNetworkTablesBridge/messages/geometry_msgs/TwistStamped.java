...
public class TwistStamped extends com.team900.lib.rosNetworkTablesBridge.messages.RosMessage {
    ...
    public TwistStamped(com.team900.lib.rosNetworkTablesBridge.messages.std_msgs.RosHeader header, com.team900.lib.rosNetworkTablesBridge.messages.geometry_msgs.Twist twist) {
        this.header = header;
        this.twist = twist;
    }
