...
public class RosInt16MultiArray extends com.team900.lib.rosNetworkTablesBridge.messages.RosMessage {
    ...
    public final java.lang.String _type = "std_msgs/Int16MultiArray";

    public RosInt16MultiArray() {

    }

    public RosInt16MultiArray(com.team900.lib.rosNetworkTablesBridge.messages.std_msgs.RosMultiArrayLayout layout, java.lang.Short[] data) {
        this.layout = layout;
        this.data = new ArrayList<>(Arrays.asList(data));
    }

    public RosInt16MultiArray(JsonObject jsonObj) {
