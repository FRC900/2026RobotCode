...
public class QuaternionStamped extends com.team900.lib.rosNetworkTablesBridge.messages.RosMessage {
    ...
    private com.team900.lib.rosNetworkTablesBridge.messages.geometry_msgs.Quaternion quaternion = new com.team900.lib.rosNetworkTablesBridge.messages.geometry_msgs.Quaternion();
    ...
    public QuaternionStamped(com.team900.lib.rosNetworkTablesBridge.messages.std_msgs.RosHeader header, com.team900.lib.rosNetworkTablesBridge.messages.geometry_msgs.Quaternion quaternion) {
        this.header = header;
    ...
    public QuaternionStamped(JsonObject jsonObj) {
        ...
        this.quaternion = new com.team900.lib.rosNetworkTablesBridge.messages.geometry_msgs.Quaternion(jsonObj.get("quaternion").getAsJsonObject());
    }

    public com.team900.lib.rosNetworkTablesBridge.messages.std_msgs.RosHeader getHeader() {
        return this.header;
    }
    public com.team900.lib.rosNetworkTablesBridge.messages.geometry_msgs.Quaternion getQuaternion() {
    ...
    public void setQuaternion(com.team900.lib.rosNetworkTablesBridge.messages.geometry_msgs.Quaternion quaternion) {
        this.quaternion = quaternion;
    }
