...
public class PoseArray extends com.team900.lib.rosNetworkTablesBridge.messages.RosMessage {
    ...
    private ArrayList<com.team900.lib.rosNetworkTablesBridge.messages.geometry_msgs.Pose> poses = new ArrayList<>();
    ...
    public PoseArray(com.team900.lib.rosNetworkTablesBridge.messages.std_msgs.RosHeader header, com.team900.lib.rosNetworkTablesBridge.messages.geometry_msgs.Pose[] poses) {
        this.header = header;
    ...
    public PoseArray(JsonObject jsonObj) {
        ...
        for (JsonElement poses_element : jsonObj.getAsJsonArray("poses")) {
            this.poses.add(new com.team900.lib.rosNetworkTablesBridge.messages.geometry_msgs.Pose(poses_element.getAsJsonObject()));
        }
    }
    ...
    public ArrayList<com.team900.lib.rosNetworkTablesBridge.messages.geometry_msgs.Pose> getPoses() {
        return this.poses;
    }
    ...
    public void setPoses(ArrayList<com.team900.lib.rosNetworkTablesBridge.messages.geometry_msgs.Pose> poses) {
        this.poses = poses;
    }
