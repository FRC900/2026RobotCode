...
public class RosUInt16MultiArray extends com.team900.lib.rosNetworkTablesBridge.messages.RosMessage {
    ...
    private ArrayList<java.lang.Short> data = new ArrayList<>();

    @Expose(serialize = false, deserialize = false)
    public final java.lang.String _type = "std_msgs/UInt16MultiArray";

    public RosUInt16MultiArray() {

    }

    public RosUInt16MultiArray(com.team900.lib.rosNetworkTablesBridge.messages.std_msgs.RosMultiArrayLayout layout, java.lang.Short[] data) {
        this.layout = layout;
        this.data = new ArrayList<>(Arrays.asList(data));
    }

    public RosUInt16MultiArray(JsonObject jsonObj) {
    ...
    public ArrayList<java.lang.Short> getData() {
        return this.data;
    }
    ...
    public void setData(ArrayList<java.lang.Short> data) {
        this.data = data;
    }
