...
public class InertiaStamped extends com.team900.lib.rosNetworkTablesBridge.messages.RosMessage {
    ...
    private com.team900.lib.rosNetworkTablesBridge.messages.geometry_msgs.Inertia inertia =
            new com.team900.lib.rosNetworkTablesBridge.messages.geometry_msgs.Inertia();
    ...
    public InertiaStamped(
            ...
            com.team900.lib.rosNetworkTablesBridge.messages.geometry_msgs.Inertia inertia) {
        this.header = header;
    ...
    public InertiaStamped(JsonObject jsonObj) {
        ...
        this.inertia =
                new com.team900.lib.rosNetworkTablesBridge.messages.geometry_msgs.Inertia(
                        jsonObj.get("inertia").getAsJsonObject());
    }
