...
public class Vector3Stamped extends com.team900.lib.rosNetworkTablesBridge.messages.RosMessage {
    ...
    private com.team900.lib.rosNetworkTablesBridge.messages.geometry_msgs.Vector3 vector = new com.team900.lib.rosNetworkTablesBridge.messages.geometry_msgs.Vector3();
    ...
    public Vector3Stamped(com.team900.lib.rosNetworkTablesBridge.messages.std_msgs.RosHeader header, com.team900.lib.rosNetworkTablesBridge.messages.geometry_msgs.Vector3 vector) {
        this.header = header;
        this.vector = vector;
    }
    ...
    public Vector3Stamped(JsonObject jsonObj) {
        ...
        this.vector = new com.team900.lib.rosNetworkTablesBridge.messages.geometry_msgs.Vector3(jsonObj.get("vector").getAsJsonObject());
    }
    ...
    public void setVector(com.team900.lib.rosNetworkTablesBridge.messages.geometry_msgs.Vector3 vector) {
        this.vector = vector;
    }
