...
public class GetMapActionResult extends com.team900.lib.rosNetworkTablesBridge.messages.RosMessage {
    ...
    private com.team900.lib.rosNetworkTablesBridge.messages.nav_msgs.GetMapResult result = new com.team900.lib.rosNetworkTablesBridge.messages.nav_msgs.GetMapResult();
    ...
    public GetMapActionResult(com.team900.lib.rosNetworkTablesBridge.messages.std_msgs.RosHeader header, com.team900.lib.rosNetworkTablesBridge.messages.actionlib_msgs.GoalStatus status, com.team900.lib.rosNetworkTablesBridge.messages.nav_msgs.GetMapResult result) {
        this.header = header;
        this.status = status;
        this.result = result;
    }
    ...
    public GetMapActionResult(JsonObject jsonObj) {
        ...
        this.result = new com.team900.lib.rosNetworkTablesBridge.messages.nav_msgs.GetMapResult(jsonObj.get("result").getAsJsonObject());
    }
    ...
    public void setResult(com.team900.lib.rosNetworkTablesBridge.messages.nav_msgs.GetMapResult result) {
        this.result = result;
    }
