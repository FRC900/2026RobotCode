...
public class TransformStamped extends com.team900.lib.rosNetworkTablesBridge.messages.RosMessage {
    ...
    private com.team900.lib.rosNetworkTablesBridge.messages.geometry_msgs.Transform transform = new com.team900.lib.rosNetworkTablesBridge.messages.geometry_msgs.Transform();
    ...
    public TransformStamped(com.team900.lib.rosNetworkTablesBridge.messages.std_msgs.RosHeader header, java.lang.String child_frame_id, com.team900.lib.rosNetworkTablesBridge.messages.geometry_msgs.Transform transform) {
        this.header = header;
    ...
    public TransformStamped(JsonObject jsonObj) {
        ...
        this.transform = new com.team900.lib.rosNetworkTablesBridge.messages.geometry_msgs.Transform(jsonObj.get("transform").getAsJsonObject());
    }
    ...
    public void setTransform(com.team900.lib.rosNetworkTablesBridge.messages.geometry_msgs.Transform transform) {
        this.transform = transform;
    }
