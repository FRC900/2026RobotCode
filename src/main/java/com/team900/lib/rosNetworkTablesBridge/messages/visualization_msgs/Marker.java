...
public class Marker extends com.team900.lib.rosNetworkTablesBridge.messages.RosMessage {
    ...
    private com.team900.lib.rosNetworkTablesBridge.messages.geometry_msgs.Vector3 scale =
            new com.team900.lib.rosNetworkTablesBridge.messages.geometry_msgs.Vector3();
    private com.team900.lib.rosNetworkTablesBridge.messages.std_msgs.RosColorRGBA color =
    ...
    public Marker(
            ...
            com.team900.lib.rosNetworkTablesBridge.messages.geometry_msgs.Vector3 scale,
            com.team900.lib.rosNetworkTablesBridge.messages.std_msgs.RosColorRGBA color,
            ...
            com.team900.lib.rosNetworkTablesBridge.messages.std_msgs.RosColorRGBA[] colors,
            java.lang.String text,
            java.lang.String mesh_resource,
    ...
    public Marker(JsonObject jsonObj) {
        ...
        this.scale =
                new com.team900.lib.rosNetworkTablesBridge.messages.geometry_msgs.Vector3(
                        jsonObj.get("scale").getAsJsonObject());
        this.color =
                new com.team900.lib.rosNetworkTablesBridge.messages.std_msgs.RosColorRGBA(
                        jsonObj.get("color").getAsJsonObject());
        this.lifetime =
                new com.team900.lib.rosNetworkTablesBridge.messages.DurationPrimitive(
        ...
        for (JsonElement colors_element : jsonObj.getAsJsonArray("colors")) {
            this.colors.add(
                    new com.team900.lib.rosNetworkTablesBridge.messages.std_msgs.RosColorRGBA(
                            colors_element.getAsJsonObject()));
        }
        this.text = jsonObj.get("text").getAsString();
        this.mesh_resource = jsonObj.get("mesh_resource").getAsString();
        this.mesh_use_embedded_materials =
                jsonObj.get("mesh_use_embedded_materials").getAsBoolean();
    }
