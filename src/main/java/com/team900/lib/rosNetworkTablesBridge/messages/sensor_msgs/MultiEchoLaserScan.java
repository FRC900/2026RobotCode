...
public class MultiEchoLaserScan extends com.team900.lib.rosNetworkTablesBridge.messages.RosMessage {
    ...
    private ArrayList<com.team900.lib.rosNetworkTablesBridge.messages.sensor_msgs.LaserEcho> ranges = new ArrayList<>();
    private ArrayList<com.team900.lib.rosNetworkTablesBridge.messages.sensor_msgs.LaserEcho> intensities = new ArrayList<>();
    ...
    public MultiEchoLaserScan(com.team900.lib.rosNetworkTablesBridge.messages.std_msgs.RosHeader header, float angle_min, float angle_max, float angle_increment, float time_increment, float scan_time, float range_min, float range_max, com.team900.lib.rosNetworkTablesBridge.messages.sensor_msgs.LaserEcho[] ranges, com.team900.lib.rosNetworkTablesBridge.messages.sensor_msgs.LaserEcho[] intensities) {
        this.header = header;
    ...
    public MultiEchoLaserScan(JsonObject jsonObj) {
        ...
        for (JsonElement ranges_element : jsonObj.getAsJsonArray("ranges")) {
            this.ranges.add(new com.team900.lib.rosNetworkTablesBridge.messages.sensor_msgs.LaserEcho(ranges_element.getAsJsonObject()));
        }
        for (JsonElement intensities_element : jsonObj.getAsJsonArray("intensities")) {
            this.intensities.add(new com.team900.lib.rosNetworkTablesBridge.messages.sensor_msgs.LaserEcho(intensities_element.getAsJsonObject()));
        }
    }
    ...
    public ArrayList<com.team900.lib.rosNetworkTablesBridge.messages.sensor_msgs.LaserEcho> getRanges() {
        return this.ranges;
    }
    public ArrayList<com.team900.lib.rosNetworkTablesBridge.messages.sensor_msgs.LaserEcho> getIntensities() {
    ...
    public void setRanges(ArrayList<com.team900.lib.rosNetworkTablesBridge.messages.sensor_msgs.LaserEcho> ranges) {
        this.ranges = ranges;
    }
    public void setIntensities(ArrayList<com.team900.lib.rosNetworkTablesBridge.messages.sensor_msgs.LaserEcho> intensities) {
