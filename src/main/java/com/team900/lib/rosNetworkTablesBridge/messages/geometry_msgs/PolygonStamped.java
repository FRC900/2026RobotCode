...
public class PolygonStamped extends com.team900.lib.rosNetworkTablesBridge.messages.RosMessage {
    ...
    private com.team900.lib.rosNetworkTablesBridge.messages.geometry_msgs.Polygon polygon = new com.team900.lib.rosNetworkTablesBridge.messages.geometry_msgs.Polygon();
    ...
    public PolygonStamped(com.team900.lib.rosNetworkTablesBridge.messages.std_msgs.RosHeader header, com.team900.lib.rosNetworkTablesBridge.messages.geometry_msgs.Polygon polygon) {
        this.header = header;
    ...
    public PolygonStamped(JsonObject jsonObj) {
        ...
        this.polygon = new com.team900.lib.rosNetworkTablesBridge.messages.geometry_msgs.Polygon(jsonObj.get("polygon").getAsJsonObject());
    }
    ...
    public void setPolygon(com.team900.lib.rosNetworkTablesBridge.messages.geometry_msgs.Polygon polygon) {
        this.polygon = polygon;
    }
