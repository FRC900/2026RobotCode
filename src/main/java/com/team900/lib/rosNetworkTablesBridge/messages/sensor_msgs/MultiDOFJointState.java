...
public class MultiDOFJointState extends com.team900.lib.rosNetworkTablesBridge.messages.RosMessage {
    ...
    private ArrayList<com.team900.lib.rosNetworkTablesBridge.messages.geometry_msgs.Twist> twist = new ArrayList<>();
    private ArrayList<com.team900.lib.rosNetworkTablesBridge.messages.geometry_msgs.Wrench> wrench = new ArrayList<>();
    ...
    public MultiDOFJointState(com.team900.lib.rosNetworkTablesBridge.messages.std_msgs.RosHeader header, java.lang.String[] joint_names, com.team900.lib.rosNetworkTablesBridge.messages.geometry_msgs.Transform[] transforms, com.team900.lib.rosNetworkTablesBridge.messages.geometry_msgs.Twist[] twist, com.team900.lib.rosNetworkTablesBridge.messages.geometry_msgs.Wrench[] wrench) {
        this.header = header;
    ...
    public MultiDOFJointState(JsonObject jsonObj) {
        ...
        for (JsonElement twist_element : jsonObj.getAsJsonArray("twist")) {
            this.twist.add(new com.team900.lib.rosNetworkTablesBridge.messages.geometry_msgs.Twist(twist_element.getAsJsonObject()));
        }
        for (JsonElement wrench_element : jsonObj.getAsJsonArray("wrench")) {
            this.wrench.add(new com.team900.lib.rosNetworkTablesBridge.messages.geometry_msgs.Wrench(wrench_element.getAsJsonObject()));
        }
    }
    ...
    public ArrayList<com.team900.lib.rosNetworkTablesBridge.messages.geometry_msgs.Twist> getTwist() {
        return this.twist;
    }
    public ArrayList<com.team900.lib.rosNetworkTablesBridge.messages.geometry_msgs.Wrench> getWrench() {
        return this.wrench;
    }
    ...
    public void setTwist(ArrayList<com.team900.lib.rosNetworkTablesBridge.messages.geometry_msgs.Twist> twist) {
        this.twist = twist;
    }
    public void setWrench(ArrayList<com.team900.lib.rosNetworkTablesBridge.messages.geometry_msgs.Wrench> wrench) {
        this.wrench = wrench;
    }
