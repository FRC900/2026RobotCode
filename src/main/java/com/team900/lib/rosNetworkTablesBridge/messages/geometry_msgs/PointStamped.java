...
public class PointStamped extends com.team900.lib.rosNetworkTablesBridge.messages.RosMessage {
    ...
    private com.team900.lib.rosNetworkTablesBridge.messages.geometry_msgs.Point point = new com.team900.lib.rosNetworkTablesBridge.messages.geometry_msgs.Point();
    ...
    public PointStamped(com.team900.lib.rosNetworkTablesBridge.messages.std_msgs.RosHeader header, com.team900.lib.rosNetworkTablesBridge.messages.geometry_msgs.Point point) {
        this.header = header;
        this.point = point;
    }
    ...
    public PointStamped(JsonObject jsonObj) {
        ...
        this.point = new com.team900.lib.rosNetworkTablesBridge.messages.geometry_msgs.Point(jsonObj.get("point").getAsJsonObject());
    }
    ...
    public void setPoint(com.team900.lib.rosNetworkTablesBridge.messages.geometry_msgs.Point point) {
        this.point = point;
    }
