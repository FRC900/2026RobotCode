...
public class AccelWithCovarianceStamped
    ...
    private com.team900.lib.rosNetworkTablesBridge.messages.geometry_msgs.AccelWithCovariance
            accel =
                    new com.team900
                            .lib
    ...
    public AccelWithCovarianceStamped(
            ...
            com.team900.lib.rosNetworkTablesBridge.messages.geometry_msgs.AccelWithCovariance
                    accel) {
        this.header = header;
        this.accel = accel;
    }
    ...
    public AccelWithCovarianceStamped(JsonObject jsonObj) {
        ...
        this.accel =
                new com.team900
                        ...
                        .messages
                        .geometry_msgs
                        .AccelWithCovariance(jsonObj.get("accel").getAsJsonObject());
    }
    ...
    public com.team900.lib.rosNetworkTablesBridge.messages.geometry_msgs.AccelWithCovariance
            getAccel() {
        return this.accel;
    }
