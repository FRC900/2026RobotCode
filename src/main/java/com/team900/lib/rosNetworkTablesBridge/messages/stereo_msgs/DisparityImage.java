...
public class DisparityImage extends com.team900.lib.rosNetworkTablesBridge.messages.RosMessage {
    ...
    private com.team900.lib.rosNetworkTablesBridge.messages.sensor_msgs.Image image =
            new com.team900.lib.rosNetworkTablesBridge.messages.sensor_msgs.Image();
    private float f = 0.0f;
    private float T = 0.0f;
    private com.team900.lib.rosNetworkTablesBridge.messages.sensor_msgs.RegionOfInterest
            valid_window =
                    new com.team900
                            .lib
    ...
    public DisparityImage(
            ...
            com.team900.lib.rosNetworkTablesBridge.messages.sensor_msgs.Image image,
            float f,
            float T,
            com.team900.lib.rosNetworkTablesBridge.messages.sensor_msgs.RegionOfInterest
                    valid_window,
            float min_disparity,
            float max_disparity,
            float delta_d) {
    ...
    public DisparityImage(JsonObject jsonObj) {
        ...
        this.image =
                new com.team900.lib.rosNetworkTablesBridge.messages.sensor_msgs.Image(
                        jsonObj.get("image").getAsJsonObject());
        ...
        this.valid_window =
                new com.team900.lib.rosNetworkTablesBridge.messages.sensor_msgs.RegionOfInterest(
                        jsonObj.get("valid_window").getAsJsonObject());
    ...
    public com.team900.lib.rosNetworkTablesBridge.messages.sensor_msgs.RegionOfInterest
            getValidWindow() {
