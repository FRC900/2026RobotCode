...
public class RosUInt8MultiArray extends com.team900.lib.rosNetworkTablesBridge.messages.RosMessage {
    ...
    public RosUInt8MultiArray() {

    }

    public RosUInt8MultiArray(com.team900.lib.rosNetworkTablesBridge.messages.std_msgs.RosMultiArrayLayout layout, java.lang.Byte[] data) {
        this.layout = layout;
        this.data = new ArrayList<>(Arrays.asList(data));
    }

    public RosUInt8MultiArray(JsonObject jsonObj) {
