...
public class GetMapResult extends com.team900.lib.rosNetworkTablesBridge.messages.RosMessage {
    ...
    private com.team900.lib.rosNetworkTablesBridge.messages.nav_msgs.OccupancyGrid map = new com.team900.lib.rosNetworkTablesBridge.messages.nav_msgs.OccupancyGrid();
    ...
    public GetMapResult(com.team900.lib.rosNetworkTablesBridge.messages.nav_msgs.OccupancyGrid map) {
        this.map = map;
    }

    public GetMapResult(JsonObject jsonObj) {
        this.map = new com.team900.lib.rosNetworkTablesBridge.messages.nav_msgs.OccupancyGrid(jsonObj.get("map").getAsJsonObject());
    }
