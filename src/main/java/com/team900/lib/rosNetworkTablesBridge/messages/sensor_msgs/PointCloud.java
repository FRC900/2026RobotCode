...
public class PointCloud extends com.team900.lib.rosNetworkTablesBridge.messages.RosMessage {
    ...
    private ArrayList<com.team900.lib.rosNetworkTablesBridge.messages.sensor_msgs.ChannelFloat32> channels = new ArrayList<>();
    ...
    public PointCloud(com.team900.lib.rosNetworkTablesBridge.messages.std_msgs.RosHeader header, com.team900.lib.rosNetworkTablesBridge.messages.geometry_msgs.Point32[] points, com.team900.lib.rosNetworkTablesBridge.messages.sensor_msgs.ChannelFloat32[] channels) {
        this.header = header;
    ...
    public PointCloud(JsonObject jsonObj) {
        ...
        for (JsonElement channels_element : jsonObj.getAsJsonArray("channels")) {
            this.channels.add(new com.team900.lib.rosNetworkTablesBridge.messages.sensor_msgs.ChannelFloat32(channels_element.getAsJsonObject()));
        }
    }
    ...
    public ArrayList<com.team900.lib.rosNetworkTablesBridge.messages.sensor_msgs.ChannelFloat32> getChannels() {
    ...
    public void setChannels(ArrayList<com.team900.lib.rosNetworkTablesBridge.messages.sensor_msgs.ChannelFloat32> channels) {
