...
public class Transform extends com.team900.lib.rosNetworkTablesBridge.messages.RosMessage {
    ...
    private com.team900.lib.rosNetworkTablesBridge.messages.geometry_msgs.Vector3 translation =
            new com.team900.lib.rosNetworkTablesBridge.messages.geometry_msgs.Vector3();
    private com.team900.lib.rosNetworkTablesBridge.messages.geometry_msgs.Quaternion rotation =
    ...
    public Transform(
            com.team900.lib.rosNetworkTablesBridge.messages.geometry_msgs.Vector3 translation,
            com.team900.lib.rosNetworkTablesBridge.messages.geometry_msgs.Quaternion rotation) {
    ...
    public Transform(JsonObject jsonObj) {
        this.translation =
                new com.team900.lib.rosNetworkTablesBridge.messages.geometry_msgs.Vector3(
                        jsonObj.get("translation").getAsJsonObject());
        this.rotation =
                new com.team900.lib.rosNetworkTablesBridge.messages.geometry_msgs.Quaternion(
                        jsonObj.get("rotation").getAsJsonObject());
    }
