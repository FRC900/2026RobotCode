...
public class MultiDOFJointTrajectoryPoint
    ...
    private ArrayList<com.team900.lib.rosNetworkTablesBridge.messages.geometry_msgs.Twist>
            velocities = new ArrayList<>();
    private ArrayList<com.team900.lib.rosNetworkTablesBridge.messages.geometry_msgs.Twist>
            accelerations = new ArrayList<>();
    private com.team900.lib.rosNetworkTablesBridge.messages.DurationPrimitive time_from_start =
    ...
    public MultiDOFJointTrajectoryPoint(
            ...
            com.team900.lib.rosNetworkTablesBridge.messages.geometry_msgs.Twist[] velocities,
            com.team900.lib.rosNetworkTablesBridge.messages.geometry_msgs.Twist[] accelerations,
            com.team900.lib.rosNetworkTablesBridge.messages.DurationPrimitive time_from_start) {
        ...
        for (JsonElement velocities_element : jsonObj.getAsJsonArray("velocities")) {
            this.velocities.add(
                    new com.team900.lib.rosNetworkTablesBridge.messages.geometry_msgs.Twist(
                            velocities_element.getAsJsonObject()));
        }
        for (JsonElement accelerations_element : jsonObj.getAsJsonArray("accelerations")) {
            this.accelerations.add(
                    new com.team900.lib.rosNetworkTablesBridge.messages.geometry_msgs.Twist(
                            accelerations_element.getAsJsonObject()));
        }
        this.time_from_start =
                new com.team900.lib.rosNetworkTablesBridge.messages.DurationPrimitive(
                        jsonObj.get("time_from_start").getAsJsonObject());
    }
    ...
    public void setVelocities(
            ArrayList<com.team900.lib.rosNetworkTablesBridge.messages.geometry_msgs.Twist>
                    velocities) {
