...
public class AccelWithCovariance extends com.team900.lib.rosNetworkTablesBridge.messages.RosMessage {

    private com.team900.lib.rosNetworkTablesBridge.messages.geometry_msgs.Accel accel = new com.team900.lib.rosNetworkTablesBridge.messages.geometry_msgs.Accel();
    ...
    public AccelWithCovariance(com.team900.lib.rosNetworkTablesBridge.messages.geometry_msgs.Accel accel, java.lang.Double[] covariance) {
        this.accel = accel;
    ...
    public AccelWithCovariance(JsonObject jsonObj) {
        this.accel = new com.team900.lib.rosNetworkTablesBridge.messages.geometry_msgs.Accel(jsonObj.get("accel").getAsJsonObject());
    ...
    public void setAccel(com.team900.lib.rosNetworkTablesBridge.messages.geometry_msgs.Accel accel) {
        this.accel = accel;
    }
