...
public class TimeReference extends com.team900.lib.rosNetworkTablesBridge.messages.RosMessage {
    ...
    private com.team900.lib.rosNetworkTablesBridge.messages.TimePrimitive time_ref =
    ...
    public TimeReference(
            ...
            com.team900.lib.rosNetworkTablesBridge.messages.TimePrimitive time_ref,
    ...
    public TimeReference(JsonObject jsonObj) {
        ...
        this.time_ref =
                new com.team900.lib.rosNetworkTablesBridge.messages.TimePrimitive(
                        jsonObj.get("time_ref").getAsJsonObject());
