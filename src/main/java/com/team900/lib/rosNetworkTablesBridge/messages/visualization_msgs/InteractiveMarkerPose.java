...
public class InteractiveMarkerPose extends com.team900.lib.rosNetworkTablesBridge.messages.RosMessage {
    ...
    public InteractiveMarkerPose(com.team900.lib.rosNetworkTablesBridge.messages.std_msgs.RosHeader header, com.team900.lib.rosNetworkTablesBridge.messages.geometry_msgs.Pose pose, java.lang.String name) {
        this.header = header;
        this.pose = pose;
        this.name = name;
    }
