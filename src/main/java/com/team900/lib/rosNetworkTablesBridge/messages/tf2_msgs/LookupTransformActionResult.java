...
public class LookupTransformActionResult extends com.team900.lib.rosNetworkTablesBridge.messages.RosMessage {
    ...
    private com.team900.lib.rosNetworkTablesBridge.messages.tf2_msgs.LookupTransformResult result = new com.team900.lib.rosNetworkTablesBridge.messages.tf2_msgs.LookupTransformResult();
    ...
    public LookupTransformActionResult(com.team900.lib.rosNetworkTablesBridge.messages.std_msgs.RosHeader header, com.team900.lib.rosNetworkTablesBridge.messages.actionlib_msgs.GoalStatus status, com.team900.lib.rosNetworkTablesBridge.messages.tf2_msgs.LookupTransformResult result) {
        this.header = header;
        this.status = status;
        this.result = result;
    }
    ...
    public LookupTransformActionResult(JsonObject jsonObj) {
        ...
        this.result = new com.team900.lib.rosNetworkTablesBridge.messages.tf2_msgs.LookupTransformResult(jsonObj.get("result").getAsJsonObject());
    }
    ...
    public com.team900.lib.rosNetworkTablesBridge.messages.tf2_msgs.LookupTransformResult getResult() {
        return this.result;
    }
    ...
    public void setResult(com.team900.lib.rosNetworkTablesBridge.messages.tf2_msgs.LookupTransformResult result) {
        this.result = result;
    }
