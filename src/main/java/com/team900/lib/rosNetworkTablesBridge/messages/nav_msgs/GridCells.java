...
public class GridCells extends com.team900.lib.rosNetworkTablesBridge.messages.RosMessage {
    ...
    private ArrayList<com.team900.lib.rosNetworkTablesBridge.messages.geometry_msgs.Point> cells = new ArrayList<>();
    ...
    public GridCells(com.team900.lib.rosNetworkTablesBridge.messages.std_msgs.RosHeader header, float cell_width, float cell_height, com.team900.lib.rosNetworkTablesBridge.messages.geometry_msgs.Point[] cells) {
        this.header = header;
    ...
    public GridCells(JsonObject jsonObj) {
        ...
        for (JsonElement cells_element : jsonObj.getAsJsonArray("cells")) {
            this.cells.add(new com.team900.lib.rosNetworkTablesBridge.messages.geometry_msgs.Point(cells_element.getAsJsonObject()));
        }
    }
    ...
    public ArrayList<com.team900.lib.rosNetworkTablesBridge.messages.geometry_msgs.Point> getCells() {
        return this.cells;
    }
    ...
    public void setCells(ArrayList<com.team900.lib.rosNetworkTablesBridge.messages.geometry_msgs.Point> cells) {
        this.cells = cells;
    }
