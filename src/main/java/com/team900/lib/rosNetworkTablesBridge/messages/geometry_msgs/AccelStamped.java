...
public class AccelStamped extends com.team900.lib.rosNetworkTablesBridge.messages.RosMessage {
    ...
    public AccelStamped(com.team900.lib.rosNetworkTablesBridge.messages.std_msgs.RosHeader header, com.team900.lib.rosNetworkTablesBridge.messages.geometry_msgs.Accel accel) {
        this.header = header;
        this.accel = accel;
    }
