...
public class RosUInt32MultiArray extends com.team900.lib.rosNetworkTablesBridge.messages.RosMessage {
    ...
    public final java.lang.String _type = "std_msgs/UInt32MultiArray";

    public RosUInt32MultiArray() {

    }

    public RosUInt32MultiArray(com.team900.lib.rosNetworkTablesBridge.messages.std_msgs.RosMultiArrayLayout layout, java.lang.Integer[] data) {
        this.layout = layout;
        this.data = new ArrayList<>(Arrays.asList(data));
    }

    public RosUInt32MultiArray(JsonObject jsonObj) {
