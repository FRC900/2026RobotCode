...
public class JointTrajectory extends com.team900.lib.rosNetworkTablesBridge.messages.RosMessage {
    ...
    private ArrayList<com.team900.lib.rosNetworkTablesBridge.messages.trajectory_msgs.JointTrajectoryPoint> points = new ArrayList<>();
    ...
    public JointTrajectory(com.team900.lib.rosNetworkTablesBridge.messages.std_msgs.RosHeader header, java.lang.String[] joint_names, com.team900.lib.rosNetworkTablesBridge.messages.trajectory_msgs.JointTrajectoryPoint[] points) {
        this.header = header;
    ...
    public JointTrajectory(JsonObject jsonObj) {
        ...
        for (JsonElement points_element : jsonObj.getAsJsonArray("points")) {
            this.points.add(new com.team900.lib.rosNetworkTablesBridge.messages.trajectory_msgs.JointTrajectoryPoint(points_element.getAsJsonObject()));
        }
    }
    ...
    public ArrayList<com.team900.lib.rosNetworkTablesBridge.messages.trajectory_msgs.JointTrajectoryPoint> getPoints() {
        return this.points;
    }
    ...
    public void setPoints(ArrayList<com.team900.lib.rosNetworkTablesBridge.messages.trajectory_msgs.JointTrajectoryPoint> points) {
        this.points = points;
    }
