...
public class PoseStamped extends com.team900.lib.rosNetworkTablesBridge.messages.RosMessage {
    ...
    public PoseStamped(com.team900.lib.rosNetworkTablesBridge.messages.std_msgs.RosHeader header, com.team900.lib.rosNetworkTablesBridge.messages.geometry_msgs.Pose pose) {
        this.header = header;
        this.pose = pose;
    }
