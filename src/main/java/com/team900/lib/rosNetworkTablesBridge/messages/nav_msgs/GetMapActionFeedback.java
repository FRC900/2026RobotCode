...
public class GetMapActionFeedback extends com.team900.lib.rosNetworkTablesBridge.messages.RosMessage {
    ...
    private com.team900.lib.rosNetworkTablesBridge.messages.nav_msgs.GetMapFeedback feedback = new com.team900.lib.rosNetworkTablesBridge.messages.nav_msgs.GetMapFeedback();
    ...
    public GetMapActionFeedback(com.team900.lib.rosNetworkTablesBridge.messages.std_msgs.RosHeader header, com.team900.lib.rosNetworkTablesBridge.messages.actionlib_msgs.GoalStatus status, com.team900.lib.rosNetworkTablesBridge.messages.nav_msgs.GetMapFeedback feedback) {
        this.header = header;
        this.status = status;
    ...
    public GetMapActionFeedback(JsonObject jsonObj) {
        ...
        this.feedback = new com.team900.lib.rosNetworkTablesBridge.messages.nav_msgs.GetMapFeedback(jsonObj.get("feedback").getAsJsonObject());
    }
    ...
    public void setFeedback(com.team900.lib.rosNetworkTablesBridge.messages.nav_msgs.GetMapFeedback feedback) {
        this.feedback = feedback;
    }
