...
public class Temperature extends com.team900.lib.rosNetworkTablesBridge.messages.RosMessage {
    ...
    public Temperature(com.team900.lib.rosNetworkTablesBridge.messages.std_msgs.RosHeader header, double temperature, double variance) {
        this.header = header;
