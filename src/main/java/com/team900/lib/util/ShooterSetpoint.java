...
public class ShooterSetpoint {
    ...
    public static double getPhi(double r, double vf) {
        String phiModelPath = new String("src/main/java/com/team900/lib/util/phi_shooter_model.json");
        ProjectilePolynomialModelFit phiShootingModel = ProjectilePolynomialModelFit.load(phiModelPath);
