...
public class ShooterSetpoint {
    ...
    static {
        try {
            ...
            phiShootingModel =
                    PolynomialModel.load(base + "/shooting_models/phi_shooter_model.json");
            thetaShootingModel =
                    PolynomialModel.load(base + "/shooting_models/theta_shooter_model.json");
        } catch (IOException e) {
    ...
    public static ShooterSetpoint setpointHubPolynomial() {
        Translation2d hub =
        ...
        return new ShooterSetpoint(
                ShooterConstants.ShooterStage2.kShootingRPS, hoodSetpoint, 0.0, turretRadiansFromCenter, 0.0);
    }
