...
# load models
with open('ProjectileMotionSim/PassingSurfaces/models/phi_model.pkl', 'rb') as f:
    phi_model = pickle.load(f)
with open('ProjectileMotionSim/PassingSurfaces/models/theta_model.pkl', 'rb') as f:
...
fig1.savefig("ProjectileMotionSim/PassingSurfaces/plots/theta_surface.png", dpi=300, bbox_inches='tight') # save plot 1
...
fig2.savefig("ProjectileMotionSim/PassingSurfaces/plots/phi_surface.png", dpi=300, bbox_inches='tight') # save plot 2
...
ax3.set_title('Theta: Data (viridis) vs Polynomial Fit (cool) (launch speed = 22.5 m/s)')
fig3.savefig("ProjectileMotionSim/PassingSurfaces/plots/theta_overlay.png", dpi=300, bbox_inches='tight')
...
ax4.set_title('Theta Polynomial Fit (launch speed = 22.5 m/s)')
fig4.colorbar(surf4, ax=ax4, shrink=0.5, aspect=10)
fig4.savefig("ProjectileMotionSim/PassingSurfaces/plots/theta_fit.png", dpi=300, bbox_inches='tight')
...
ax5.set_title('Phi: Data (plasma) vs Polynomial Fit (cool) (launch speed = 22.5 m/s)')
fig5.savefig("ProjectileMotionSim/PassingSurfaces/plots/phi_overlay.png", dpi=300, bbox_inches='tight')
...
ax6.set_title('Phi Polynomial Fit (launch speed = 22.5 m/s)')
fig6.colorbar(surf6, ax=ax6, shrink=0.5, aspect=10)
fig6.savefig("ProjectileMotionSim/PassingSurfaces/plots/phi_fit.png", dpi=300, bbox_inches='tight')
